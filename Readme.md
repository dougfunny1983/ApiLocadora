Essa solução feita totalmente feita em DDD/Onion é uma API, documentada pelo Swagger, com a camada de persistência de dados no banco não relacional Mongo DB com alguns designer patterns.
**Arquitetura:
